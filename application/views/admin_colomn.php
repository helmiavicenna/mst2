<div class="grid_5">
            <div class="box round">
                ...
                <div class="block">
                    <p class="start">
                        <img src="<?php echo base_url(); ?>/assets/img/horizontal.jpg" alt="Ginger" class="left" />Lorem ipsum dolor sit
        ...
        <div class="grid_5">
            <div class="box round">
                ...
                <div class="block">
                    <p class="start">
                        <img src="<?php echo base_url(); ?>/assets/img/vertical.jpg" alt="Ginger" class="right" />Lorem Ipsum is simply dummy
