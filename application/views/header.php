...
<div id="main_container">
  ...
  <div id="header">
    <div id="logo"><img src="<?php echo base_url(); ?>/assets/images/logo.png" alt="" border="0" width="237" height="140" /> </div>
  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        ...
        <li class="divider"></li>
        <li><a href="#" class="nav2">Product</a></li>
        <li class="divider"></li>
        <li><a href="#" class="nav3">Discount</a></li>
        <li class="divider"></li>
        <li><a href="#" class="nav4">Account</a></li>
        <li class="divider"></li>
        <li><a href="contact.html" class="nav4">Contact</a></li>
        <li class="divider"></li>
        <li><a href="#" class="nav5">Shipping</a></li>
        <li class="divider"></li>
        <li><a href="#" class="nav6">Logout</a></li>
        <li class="divider"></li>
